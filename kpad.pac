...
//
var noadsver = "$Id: no-ads.pac,v 6.6 2020/03/30 02:10:59 loverso Exp loverso $";
...
var re_adhost = /\b((new)?ad(?!(venture|vantage|am|mission|visor|alur|iumx|ult|vizia|obe|min|sl|d|olly|vance))|ads\b|adserv|pop(?!ular|corn|e)|click(?!redblue|andbuy|.reference)|cash(?!back|star)|banner|bans)/i;
